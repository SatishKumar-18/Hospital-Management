	...
	<header class="header" id="header">
        <nav class="nav container">
            ...
            <div class="nav_menu" id="nav-menu">
                <ul class="nav_list">
                    <li class="nav_list">
                        <a href="DoctorViewAppointment.jsp" class="nav_link active-link">View Appointment</a>
                    </li>
                    <li class="nav_list">
    						...
    						<td>
    							<%
    								if("pending".equalsIgnoreCase(app.getStatus())){%>
    									<a href="DoctorComment.jsp?id=<%= app.getId() %>" class="commentBtn">Comment</a>
    								<%}else{%>
    									<a href="" class="disabled">Comment</a>
    								<%}
    							%>
