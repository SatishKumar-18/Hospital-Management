	...
	<header class="header" id="header">
        <nav class="nav container">
            ...
            <div class="nav_menu" id="nav-menu">
                <ul class="nav_list">
                    <li class="nav_list">
                        <a href="UserAppointment.jsp" class="nav_link">Appointment</a>
                    </li>
                    <li class="nav_list">
                        <a href="UserViewAppointment.jsp" class="nav_link active-link">View Appointment</a>
                    </li>
                    <li class="nav_list">
    	...
    	<table>
    		...
    		<tbody>
    			<%
                    ...
                    List<Appointment> list = dao.getAppointmentByUser(id);
